...
export default class Enroll extends template {
  ...
  async getMain() {
    ...
    enroll.appendChild(enroll_id);
    enroll.appendChild(enroll_pw);
    enroll.appendChild(enroll_studentID);
    enroll.appendChild(enroll_studentName);
    enroll.appendChild(enroll_btn);
    enroll_btn.appendChild(enroll_btn_confirm);
    enroll_btn.appendChild(enroll_btn_toHome);

    enroll.id = `enroll`;
    enroll_id.id = `enroll-id`;
    enroll_id.classList.add(`enroll-box`);
    enroll_pw.id = `enroll-pw`;
    enroll_pw.classList.add(`enroll-box`);
    enroll_studentID.id = `enroll-studentnumber`;
    enroll_studentID.classList.add(`enroll-box`);
    enroll_studentName.id = `enroll-studentname`;
    enroll_studentName.classList.add(`enroll-box`);
    enroll_btn.id = `enroll-btn`;
    enroll_btn_confirm.id = `enroll-btn-confirm`;
    enroll_btn_confirm.classList.add(`enroll-btn-box`);
    enroll_btn_toHome.id = `enroll-btn-toHome`;
    enroll_btn_toHome.classList.add(`enroll-btn-box`);
    ...
    enroll_id.setAttribute(
      "onblur",
      "this.placeholder='아이디를 입력해주세요'"
    );
    ...
    enroll_studentID.setAttribute(
      "onblur",
      "this.placeholder='학번을 입력해주세요'"
    );
    ...
    enroll_studentName.setAttribute(
      "onblur",
      "this.placeholder='이름을 입력해주세요'"
    );
