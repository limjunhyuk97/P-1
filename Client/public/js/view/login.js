...
export default class login extends template {
  ...
  async getMain() {
    ...
    login.appendChild(login_id);
    login.appendChild(login_pw);
    login.appendChild(login_btn);
    login_btn.appendChild(login_btn_enroll);
    login_btn.appendChild(login_btn_login);

    login.id = `login`;
    login_id.id = `login-id`;
    login_id.classList.add(`login-box`);
    login_pw.id = `login-pw`;
    login_pw.classList.add(`login-box`);
    login_btn.id = `login-btn`;
    login_btn_enroll.id = `login-btn-enroll`;
    login_btn_enroll.classList.add(`login-btn-box`);
    login_btn_login.id = `login-btn-login`;
    login_btn_login.classList.add(`login-btn-box`);
